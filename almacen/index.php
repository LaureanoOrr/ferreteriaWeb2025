                ...
                <tbody>
                  ...
                  foreach ($productos_datos as $productos_dato) {
                    ...
                    <tr>
                      ...
                      <!-- cambiar de  color dependiendo stock maximo y minimo -->
                      <?php
                      $stock_actual = $productos_dato['stock'];
                      $stock_minimo = $productos_dato['stock_minimo'];
                      $stock_maximo = $productos_dato['stock_maximo'];
                      if ($stock_actual < $stock_minimo) { ?>
                        <td style="color: #dc3746; font-weight: bold; "><center><?php echo $productos_dato['stock'] ?></td></center>
                      <?php
                      } else if ($stock_actual > $stock_maximo) { ?>
                        <td style="color: #28a745; font-weight: bold; "><center><?php echo $productos_dato['stock'] ?></td></center>
                      <?php
                      } else { ?>
