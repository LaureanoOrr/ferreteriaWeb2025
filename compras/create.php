                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="stock" id="stock" class="form-control" style="background-color: #cfe6ff" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="cuit" class="form-control" disabled>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for=""> Precio Compra:</label>
                                                <input type="number" class="form-control" id="precio_compra_detalle">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for=""> Stock ACTUAL:</label>
                                                <input type="text" id="stock_actual" class="form-control" style="background-color: #cfe6ff" disabled>
                                            </div>
                                        </div>
